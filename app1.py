...
from audio_recorder_streamlit import audio_recorder  # Use this browser-based recorder instead
...
def main():
    ...
    def record_audio():
        st.session_state.audio_data = sd.rec(int(sample_rate * st.session_state.record_duration),
